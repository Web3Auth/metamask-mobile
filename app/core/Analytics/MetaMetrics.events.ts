...
enum EVENT_NAME {
  ...
  WALLET_LOGIN_SELECTED = 'Wallet Login Selected',
  WALLET_LOGIN_COMPLETED = 'Wallet Login Completed',
  WALLET_REHYDRATION_ATTEMPTED = 'Wallet Rehydration Attempted',
...
const events = {
  ...
  WALLET_LOGIN_SELECTED: generateOpt(EVENT_NAME.WALLET_LOGIN_SELECTED),
  WALLET_LOGIN_COMPLETED: generateOpt(EVENT_NAME.WALLET_LOGIN_COMPLETED),
  WALLET_REHYDRATION_ATTEMPTED: generateOpt(
    EVENT_NAME.WALLET_REHYDRATION_ATTEMPTED,
  ),
  WALLET_REHYDRATION_COMPLETED: generateOpt(
    EVENT_NAME.WALLET_REHYDRATION_COMPLETED,
  ),
